...
if exist "CryptSync.lzma" del "CryptSync.lzma"
if exist "CryptSync.tar"  del "CryptSync.tar"
if exist "CryptSync.tgz"  del "CryptSync.tgz"
...
title "%COVDIR%\bin\cov-build.exe" --dir "cov-int" nant -buildfile:../default.build CryptSync
"%COVDIR%\bin\cov-build.exe" --dir "cov-int" nant -buildfile:../default.build CryptSync
...
title Creating "CryptSync.lzma"...
tar caf "CryptSync.lzma" "cov-int"
goto End
...
if exist "%SEVENZIP%" (
  title Creating "CryptSync.tar"...
  "%SEVENZIP%" a -ttar "CryptSync.tar" "cov-int"
  "%SEVENZIP%" a -tgzip "CryptSync.tgz" "CryptSync.tar"
  if exist "CryptSync.tar" del "CryptSync.tar"
  goto End
)
